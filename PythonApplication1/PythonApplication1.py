...
class EasyApplyLinkedin:
    ...
    def job_search(self):
     ...
     #   search_keywords = self.driver.find_element_by_id('jobs-search-box-keyword-id-ember531')
    ...
    def filter(self):
        ...
        time.sleep(1)
        apply_filter_button = self.driver.find_element_by_class_name("search-advanced-facets__button--apply")
    ...
    def submit_apply(self,job_add):
        ...
        print('You are currently applying to the position of: ', job_add.text)
        job_add.click()
        time.sleep(2)
        ...
        try:
            ...
            in_apply = self.driver.find_element_by_class_name ("jobs-apply-button")
            in_apply.click()
        except NoSuchElementException:
            print('Job allready applied to..')
            pass
        time.sleep(1)
        ...
        try:
            ...
            time.sleep(2)
            submit2 = self.driver.find_element_by_class_name("artdeco-modal__dismiss")
            submit2.send_keys(Keys.RETURN)
        
        # ... if not available, discard application and go to next
        except NoSuchElementException:
            print('This is not an application we can currently handle, going to next..')
            try:
